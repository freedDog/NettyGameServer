			...
			if(tmpURLConnection instanceof JarURLConnection) {
				...
				if(file.exists()&&file.isDirectory()) {
					...
					for(File f:fileArray) {
						...
						}else if(null==fileext||tmpItemName.endsWith(fileext)) {
