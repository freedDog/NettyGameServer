package com.game.expression;

import java.util.Arrays;
import java.util.LinkedList;
import java.util.List;

import com.game.expression.impl.AddExpression;
import com.game.expression.impl.BinaryOperationExpression;
import com.game.expression.impl.DivideExpression;
import com.game.expression.impl.ModExpression;
import com.game.expression.impl.MultipleExpression;
import com.game.expression.impl.ParamExpression;
import com.game.expression.impl.StaticExpression;
import com.game.expression.impl.SubtractExpression;

/**
 * 表达式工具类，可以将表达式字符串转换成表达式对象，然后根据具体参数值求值。
 * @author JiangBangMing
 *
 * 2018年6月27日 下午5:35:35
 */
