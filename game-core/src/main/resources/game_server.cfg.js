...
config.rpcServicePackage="com.game.service.rpc.service.server";
//config.rpcTimeOut=60*1000;
config.rpcTimeOut=0;
config.rpcFutureDeleteTimeOut=60*1000;
/**message**/
config.netMessageHandlerNameSpace="com.game.message.handler.impl";
config.netMsgNameSpace="com.game.message.logic";
/**异步线程池配置**/
config.asyncThreadPoolCoreSize=1;
config.asyncThreadPoolMaxSize=100;
/*事件服务*/
config.asyncEventListenerNameSpace="com.game.service.event.listener";
