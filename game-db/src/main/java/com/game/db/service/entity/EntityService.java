...
import com.game.db.common.annotation.DbMapper;
...
import com.game.db.entity.BaseLongIDEntity;
import com.game.db.entity.BaseStringIDEntity;
import com.game.db.entity.IEntity;
import com.game.db.service.jdbc.mapper.IDBMapper;
import com.game.db.service.proxy.EntityProxyWrapper;
import com.game.db.sharding.CustomerContextHolder;
...
public abstract class EntityService<T extends AbstractEntity> implements IEntityService<T> {
	...
	public void updateEntity(T entity) {
		...
		if(entityProxyWrapper!=null&&entityProxyWrapper.getEntityProxy().isDirtyFlag()) {
			...
			IDBMapper<T> idbMapper=getTemplateMapper(entity);
			try {
				idbMapper.updateEntity(hashMap);
			}catch (Exception e) {
				logger.error(e.toString(),e);
			}finally {
